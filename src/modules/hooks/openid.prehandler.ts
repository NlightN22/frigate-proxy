...
// import { oidpSettingsKeys } from "../config/oidp/oidp.settings";
...
//     clientId: (await configService.getDecryptedConfig(oidpSettingsKeys.clientId)).value,
//     clientSecret: (await configService.getDecryptedConfig(oidpSettingsKeys.clientSecret)).value,
//     realmURL: (await configService.getDecryptedConfig(oidpSettingsKeys.realmUrl)).value,
//   }
//   return config
// }
