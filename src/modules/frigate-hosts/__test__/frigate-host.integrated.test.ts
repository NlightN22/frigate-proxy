...
async function createHost(fastify: FastifyInstance, t: Test) {
...
test('Frigate-hosts integrated tests', t => {
    let hostData
    ...
    t.before(() => {
        ...
        sinon.stub(FrigateCamerasUpdater, 'initialize')
        fastify = buildServer()
    ...
    t.beforeEach(async (t) => {
        ...
        hostData = await createHost(fastify, t)
    })
